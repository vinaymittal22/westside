...
export function filterProducts(
  ...
  for (const p of products) {
    /* ── Hard filter: gender ─────────────────────────────────── */
    if (filters.gender !== "all" && p.gender !== filters.gender) continue;
...
const OCCASION_KEYWORDS: Record<string, string[]> = {
  wedding:      ["wedding", "bridal", "bride", "reception", "shaadi", "nikah", "marriage"],
  party:        ["party", "celebration", "birthday", "anniversary", "night out", "club"],
  casual:       ["casual", "everyday", "daily", "regular", "simple", "comfortable"],
  office:       ["office", "work", "professional", "business", "corporate", "meeting", "job"],
  festival:     ["festival", "diwali", "navratri", "eid", "holi", "puja", "pooja", "traditional", "ethnic"],
  "date night": ["date", "romantic", "dinner", "evening out", "special night"],
  vacation:     ["vacation", "holiday", "travel", "beach", "trip", "tour"],
};
